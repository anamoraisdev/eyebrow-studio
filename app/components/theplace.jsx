    ...
    return (
        <div className="flex items-center justify-around px-20 py-40">
            ...
            <div className="flex items-center">
                <img src="/place1.jpeg" className="w-auto h-[18rem] mr-[-20px] transform rotate-6"/>
                <img src="/place2.jpeg" className="w-auto h-[18rem] mr-[-20px] transform -rotate-6"/>
                <img src="/place3.jpeg" className="w-auto h-[18rem] mr-[-20px] transform rotate-6"/>
            </div>
        </div>
)}
